...
h3. How to create a new fresh repository
...
h3. Cleaning up: branches, remotes, pruning, etc
...
h3. Create local branches (to track remote branches)
...
h2. svn revert - undoing a change in a single file.
...
h2. Make a change and commit to the local repository.
...
h3. get new files on this branch that someone else may have made
...
h2. Merge in code from the most up to date version of master
...
h3. push current version to git repository
...
h2. Push - pushing your code to the remote repository
...
h2. Clean and other useful things
...
h3. Handy commands from: schacon@gmail.com

h4. books/sites
* Git Internals
* Pro Git proGit.org

h4. incremental changes

git add -p (add chunks)

h4. viewing _whole_ tree
gitk --all
git log --graph --all

h4. remote servers/repositories
